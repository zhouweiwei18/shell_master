...
# $2 : 中心IP
# $3 : 偏移秒数  如：+60 向后偏移60秒    -60 向前偏移60秒   （默认值：-30）
# $4 : 加解密工具路径（默认值：/home/dhcp4/tools/EncryptionTool/crygen）
...
# $2 : 中心IP：1.1.1.1
# $3 : 偏移秒数  如：+60 向后偏移60秒    -60 向前偏移60秒   （默认值：-30）
# $4 : 加解密工具路径（默认值：/home/dhcp4/tools/EncryptionTool/crygen）：/home/bmreport/work/zhouww/tools/crygen
# $5 : app路径（默认值: /home/dhcp4/app）
inspect_qps_utilization "mysql -h10.21.17.145 -P23306 -udhcp4_dev -phDJ8D/V2JntDIDUsD0kAgA== -DLCDMP4_SEPE_DEV" "1.1.1.1" "" "/home/bmreport/work/zhouww/tools/crygen" ""